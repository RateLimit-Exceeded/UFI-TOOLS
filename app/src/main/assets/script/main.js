...
function main_func() {
    ...
    const resetTheme = async (e) => {
        ...
        let color = localStorage.removeItem('themeColor');
        let colorPer = localStorage.removeItem('colorPer');
        let opacityPer = localStorage.removeItem('opacityPer');
        let value = localStorage.removeItem('brightPer');
        let saturation = localStorage.removeItem('saturationPer');
        let textColor = localStorage.removeItem('textColor');
        let textColorPer = localStorage.removeItem('textColorPer');
        let blur = localStorage.removeItem('blurSwitch');
        let overlay = localStorage.removeItem('overlaySwitch');
        location.reload()
        initTheme && initTheme()
        e.target.innerHTML = t('reset_theme_btn')
